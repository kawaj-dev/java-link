...
開発者自身がJavaを学び始めたときに感じた「わからない」は、初心者の今だからこそ持てる大切な視点だと考え、教材設計に取り入れています。
...
- 初めて見るコードでも、左から一つずつ意味を追いながら読み進められるようになる
- コードの一部分だけでなく、全体の流れを捉えられるようになる
- 繰り返し登場するコードに触れることで、その意味や役割を自然に身につけられる
- すべてのコードに説明があることで、「わからないところが出るたびに学習を中断して調べる」という負担を減らしながら学習を進められる
